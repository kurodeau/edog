...
//	isConfirm tinyint(1)
	...
	public String toString() {
		return "BuyerVO [memberId=" + memberId + ", memberEmail=" + memberEmail + ", thirdFrom=" + thirdFrom
				+ ", memberName=" + memberName + ", memberPhone=" + memberPhone + ", mobile=" + mobile
				...
				+ memberRegistrationTime + ", petName=" + petName + ", petVaccName1=" + petVaccName1 + ", petVaccTime1="
				+ petVaccTime1 + ", petVaccName2=" + petVaccName2 + ", petVaccTime2=" + petVaccTime2 + ", petImg="
				+ Arrays.toString(petImg) + ", petImgUploadTime=" + petImgUploadTime + "]";
	}
