...
<body>
	...
	<h2>員工系統</h2>
	<a
		href="${pageContext.request.contextPath}/seller/seller.do?action=getAll">查詢所有員工</a>
	<br>
	<br>
	<jsp:useBean id="sellerSvc" scope="page"
		class="com.seller.service.SellerService" />

	<FORM METHOD="post" ACTION="seller.do">
		<b>選擇編號</b> <select size="1" name="sellerId">
